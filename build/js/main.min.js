...
function searchForm() {
  ...
  if (searchForms.length) {
    searchForms.forEach(function (form) {
      var searchFormSubmitBtn = form.querySelector('.search__form-submit');
      form.addEventListener('submit', function (e) {
        e.preventDefault();
      });
      searchFormSubmitBtn === null || searchFormSubmitBtn === void 0 ? void 0 : searchFormSubmitBtn.addEventListener('click', function () {
        form.submit();
      });
      searchFormFiltersBtn === null || searchFormFiltersBtn === void 0 ? void 0 : searchFormFiltersBtn.addEventListener('click', function () {
        form.classList.add('search__form--active');
        document.body.classList.add('scroll-lock');
      });
      searchFormBackBtn === null || searchFormBackBtn === void 0 ? void 0 : searchFormBackBtn.addEventListener('click', function () {
